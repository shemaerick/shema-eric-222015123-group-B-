...
import Menu.MenuForms;
import Regstr.Admin;
import Signing.SiningUp;


public class LogingUp  extends JFrame {
...
public LogingUp() {
    ...
    forgotPasswordButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            ...
            String email = JOptionPane.showInputDialog(LogingUp.this, "Enter your email:");
            if (email != null && !email.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(LogingUp.this, "A password reset link has been sent to your email.");
            } else {
                JOptionPane.showMessageDialog(LogingUp.this, "Please enter a valid email.");
            }
        }
    });
    ...
    createAccountButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
       	 ...
       	 SiningUp registrationForm = new SiningUp();
